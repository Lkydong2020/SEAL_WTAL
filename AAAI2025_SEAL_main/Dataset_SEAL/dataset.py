...
class VideoDataset:
    ...
    def get_proposals(self, only_test=True):
        ...
        """
        proposals_file_test = os.path.join('./proposals4Thumos14', 'Proposals_thumos14_train.json')
        with open(proposals_file_test, "r") as f:
            proposals_json_test = json.load(f)["results"]
        if not only_test:
            proposals_file_train = os.path.join('./proposals4Thumos14', 'Proposals_thumos14_test.json')
