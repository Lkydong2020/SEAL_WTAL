...
def Process_consistency_loss(self, proposals, prop_attn, prop_ciou, device, mask, args):
        """
        ...
        Inputs:
            ...
            args: additional arguments with alpha_5 and alpha_6 for weighting losses
